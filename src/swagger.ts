...
const swaggerOptions: Options = {
  definition: {
    ...
    servers: [
      ...
      {
        url: "https://demo-credit-ev4y.onrender.com",
    ...
    components: {
      ...
      responses: {
        ...
        "401": {
          description:
            "Unauthorized - Authentication is needed to get the requested response",
          content: {
            "application/json": {
              schema: {
                $ref: "#/components/schemas/Error",
  ...
  apis: ["./src/deliverymen/*.ts", "./src/deliverymen/*.delivery.ts"],
};
